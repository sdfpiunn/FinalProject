...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='C:/Users/zhany/Desktop/ultralytics-yolo11-main/runs/train/yolov82/weights/best.pt', help='trained weights path')
